...
- Assume the app is logged out when the test starts
...
- For email notifications the emulator has the gmail app signed in with the correct account. Assume it will work. Locking is OK. 

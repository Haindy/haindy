...
from haindy.error_handling.aggregator import ErrorReport
from haindy.journal.models import ExecutionJournal
...
class TestReporter:
    ...
    def _convert_to_metrics(self, test_state: TestState) -> TestMetrics:
        ...
        if test_state.start_time and test_state.end_time:
            (test_state.end_time - test_state.start_time).total_seconds()
        elif test_state.start_time:
            (now - test_state.start_time).total_seconds()
        else:
            pass

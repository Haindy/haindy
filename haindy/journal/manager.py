...
from haindy.core.types import ActionType, TestPlan, TestStep
from haindy.journal.adapters import (
    enhanced_to_journal_action_result,
    extract_journal_context,
)
...
class JournalManager:
    ...
    async def get_journal(self, journal_id: UUID) -> ExecutionJournal | None:
        """Get a journal by ID."""
    ...
    async def _load_journal(self, journal_file: Path) -> ExecutionJournal | None:

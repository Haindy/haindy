...
class VisibilityResult:
    ...
    coordinates: str | None = None  # Grid coordinates like "M23"
    confidence: float = 0.0
    visible_percentage: int | None = None  # For partial visibility
    suggested_direction: ScrollDirection | None = None

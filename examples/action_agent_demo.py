...
def save_demo_images(
    ...
    print("  - Original: demo_screenshot.png")
    print("  - With grid: demo_screenshot_grid.png")
...
async def demonstrate_action_agent():
    ...
    await agent.determine_action(screenshot, nav_instruction)
    ...
    print("- All coordinates mapped to precise pixel locations")
